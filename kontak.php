                    ...
                    <form style="margin-top: 1.5rem;" action="" method="post">
                        <div style="margin-bottom: 1.75rem;">
                            ...
                            <div class="d-flex w-100 div-input-content-3-5">
                                <input class="input-field-content-3-5" name="nama" placeholder="Masukkan Nama Lengkap Kamu" autocomplete="on" required>
                            </div>
                        </div>
                        ...
                        <div style="margin-bottom: 1.75rem;">
                            ...
                            <div class="d-flex w-100 div-input-content-3-5">
                                <input class="input-field-content-3-5" type="email" name="email" id="email" placeholder="Masukkan Email Kamu" autocomplete="on" required>
                            </div>
                        </div>
